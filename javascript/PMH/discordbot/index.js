    ...
    if (nu.content.endsWith('#detail')) {
      ...
      superagent.get('http://pmh.dps0340.xyz:8080/check/' + query).then((res) => {
        let emb = new discord.RichEmbed()
          ...
          .addField('Pre-Process', res.body.preProcess)
          .addField(!res.body.process['KR-P1'] ? 'EN-P1': 'KR-P1', !res.body.process['KR-P1'] ? res.body.process['EN-P1']: res.body.process['KR-P1'])
          if (res.body.process['KR-P2'] || res.body.process['EN-P2']) emb.addField(!res.body.process['KR-P2'] ? 'EN-P2': 'KR-P2', !res.body.process['KR-P2'] ? res.body.process['EN-P2']: res.body.process['KR-P2'])
          if (res.body.process['KR-P3'] || res.body.process['EN-P3']) emb.addField(!res.body.process['KR-P3'] ? 'EN-P3': 'KR-P3', !res.body.process['KR-P3'] ? res.body.process['EN-P3']: res.body.process['KR-P3'])
